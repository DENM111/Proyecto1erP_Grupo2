...
using static Proyecto_Grupo2.Program;
...
namespace Proyecto_Grupo2
{
    internal class Program
    {
        ...
        public class Pasajero
        {
            ...
            public Pasajero(int idPasajero, string nombre, string apellido, string numeroIdentificacion, int edad, string nacionalidad, string correoElectronico)
            {
            ...
            public override string ToString()
            {
                return $"ID: {IdPasajero}, Nombre: {Nombre}, Apellido: {Apellido}, ID: {NumeroIdentificacion}, Edad: {Edad}, Nacionalidad: {Nacionalidad}, Correo: {CorreoElectronico}";
            }
        }
        ...
        public class Destino
        {
            ...
            public Destino(int idDestino, string ciudad, string pais, string aeropuerto, decimal costoBoleto, string tipoVuelo, string duracionVuelo)
            {
                IdDestino = idDestino;
                Ciudad = ciudad;
                Pais = pais;
            ...
            public override string ToString()
            {
                return $"ID: {IdDestino}, Ciudad: {Ciudad}, País: {Pais}, Aeropuerto: {Aeropuerto}, Costo: {CostoBoleto:C}, Tipo de Vuelo: {TipoVuelo}, Duración: {DuracionVuelo}";
            }
        }
        ...
        public class Aerolinea
        {
            ...
            public void MostrarMenu()
            {
                ...
                Console.WriteLine("10. Agregar Pasajero");
                Console.WriteLine("11. Visualizar Pasajeros");
                Console.WriteLine("12. Imprimir Posición de Pasajero");
                Console.WriteLine("13. Agregar Destino");
                Console.WriteLine("14. Visualizar Destinos");
                Console.WriteLine("15. Imprimir Posición de Destino");
            ...
            public void AgregarPasajero()
            {
                ...
                Pasajero pasajero = new Pasajero(id, nombre, apellido, numeroIdentificacion, edad, nacionalidad, correoElectronico);
                pasajeros.Add(pasajero);
                Console.WriteLine("Pasajero agregado.");
            }

            public void VisualizarPasajeros()
            {
                Console.WriteLine("\nPasajeros:");
            ...
            public void ImprimirPosicionPasajero()
            {
                Console.WriteLine("\nImprimir Pasajero por Posición:");
                if (pasajeros.Count == 0)
                {
                    Console.WriteLine("No hay pasajeros registrados.");
                    return;
                ...
                Console.Write("Ingrese la posición del pasajero a imprimir (0-" + (pasajeros.Count - 1) + "): ");
                if (int.TryParse(Console.ReadLine(), out int posicion) && posicion >= 0 && posicion < pasajeros.Count)
                {
                    Console.WriteLine(pasajeros[posicion]);
                }
                else
                {
                    Console.WriteLine("Posición inválida.");
            ...
            public void AgregarDestino()
            {
                ...
                string aeropuerto = Console.ReadLine();
                Console.Write("Costo del Boleto: ");
                decimal costoBoleto = decimal.Parse(Console.ReadLine());
                Console.Write("Tipo de Vuelo: ");
                string tipoVuelo = Console.ReadLine();
                Console.Write("Duración del Vuelo: ");
                string duracionVuelo = Console.ReadLine();

                Destino destino = new Destino(id, ciudad, pais, aeropuerto, costoBoleto, tipoVuelo, duracionVuelo);
                destinos.Add(destino);
                Console.WriteLine("Destino agregado.");
            }

            public void VisualizarDestinos()
            {
                Console.WriteLine("\nDestinos:");
                if (destinos.Count == 0)
                {
            ...
            public void ImprimirPosicionDestino()
            {
                Console.WriteLine("\nImprimir Destino por Posición:");
                if (destinos.Count == 0)
                {
                    Console.WriteLine("No hay destinos registrados.");
                    return;
                ...
                Console.Write("Ingrese la posición del destino a imprimir (0-" + (destinos.Count - 1) + "): ");
                if (int.TryParse(Console.ReadLine(), out int posicion) && posicion >= 0 && posicion < destinos.Count)
                {
                    Console.WriteLine(destinos[posicion]);
                }
                else
                {
                    Console.WriteLine("Posición inválida.");
